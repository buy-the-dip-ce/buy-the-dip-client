import { batch, $PROXY, getListener, createSignal, createContext, useContext, useTransition, createRenderEffect, createMemo, untrack, mergeProps as mergeProps$1, splitProps, Match, Show, onCleanup } from 'solid-js';
import regexparam from 'regexparam';
import { template, createComponent, mergeProps, delegateEvents, spread, insert, effect, setAttribute } from 'solid-js/web';
...
const useRoute = () => useContext(RouteContext) || useRouter().base;
const defaultUtils = {
  resolvePath,
  createMatcher,
  parseQuery,
...
function renderChildren(props, args) {
  ...
  return typeof children === 'function' && children.length ? untrack(() => children(...args)) : children;
}
...
export { Link, MatchRoute, NavLink, Redirect, Route, Router, createIntegration, createMatcher, createRoute, createRouter, hashIntegration, historyIntegration, parseQuery, pathIntegration, renderPath, resolvePath, useRoute, useRouter };
