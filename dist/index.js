...
const Link$1 = props => MetaTag("link", props);
...
function LinkBase(props) {
  ...
  return web.ssr(_tmpl$$1, web.ssrHydrationKey(), web.ssrSpread(rest, false, true), web.escape(href(), true), web.escape(props.children));
}
...
const Posts = solidJs.lazy(() => Promise.resolve().then(function () { return require('./index-76599aa4.js'); }));
const PostDetail = solidJs.lazy(() => Promise.resolve().then(function () { return require('./index-e2375bdc.js'); }));
const Home = solidJs.lazy(() => Promise.resolve().then(function () { return require('./index-0bedf705.js'); }));
solidJs.lazy(() => Promise.resolve().then(function () { return require('./404-a080e49a.js'); }));
...
const App = ({
  ...
  return [web.createComponent(Link$1, {
    rel: "stylesheet",
    href: "index.css"
  }), web.createComponent(Router, {
    get integration() {
